# This is tt token and coin api to know how to use dm @ChauhanDev07 on telegram 
...
def send_coin():
    try:
        ...
        gas_price = w3.eth.gasPrice
        tx = {'nonce' : nonce,'to' : to,'value' : amo, 'chainId':108, 'gas' : 21000,'gasPrice' : gas_price}
